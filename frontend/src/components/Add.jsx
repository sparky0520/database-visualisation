        ...
        <div className='max-w-2xl'>
            <div className='px-8 pb-6 border-2 border-gray-400 rounded-md'>
                ...
                <div className='flex justify-between mt-4'>
                    ...
                    <button className='text-lg border-2 border-blue-500 text-blue-500 p-1 rounded-md hover:bg-blue-500 hover:text-white transition duration-400 ease-in-out' onClick={handleSaveEmployee}>Add</button>
                </div>
            </div>
        </div>
    )
